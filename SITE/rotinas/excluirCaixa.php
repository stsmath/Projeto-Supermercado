	...
	<body>
		...
		<div>
			<?php
				...
				$codigo = $_GET["cod"];
				$comandoSQL = "DELETE FROM caixa WHERE codCaixa = $codigo";
				mysqli_query($con, $comandoSQL) or
					die("Erro na exclusão dos dados: ".mysqli_error($con));
					
				echo "Dados do Caixa com código $codigo foi excluido com sucesso!<br>";
				echo "<a href='listagemCaixa.php'>Voltar</a>";
			?>
